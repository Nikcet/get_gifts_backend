...
async def parse_url_ozon(url: str):
    ...
    with SB(uc=True, headless=True) as sb:
        ...
        for selector in photo_selectors:
            try:
                photo = sb.get_attribute(selector, "src")
                if photo:
        ...
        try:
            cost_element = sb.find_element('button[class*="a2020-a4"] span span')
            ...
            try:
                cost_element = sb.find_element('div[data-widget*="webPrice"] div div div div span')
